...
<meta charset="utf-8">
    ...
    <title>Cian's Poster Store - Checkout</title>
...
HttpSession basketsess = request.getSession();
      Basket basket = (Basket) basketsess.getAttribute("basket");
          ...
          <div class="card-body p-0">
            <div class="row g-0">
              <div class="col-lg-8">
                <div class="p-5 bg-info">
                  <div class="d-flex justify-content-between align-items-center mb-5">
                    <h1 class="fw-bold mb-0 text-black">Checkout Confirmation:</h1>
                  </div>
                  <hr class="my-4">
              ...
              <div class="col-lg-4 bg-info">
                <div class="p-5">
                  <h3 class="fw-bold mb-5 mt-2 pt-1">Order Number #765</h3>
                  <hr class="my-4">
                  ...
                  <div class="d-flex justify-content-between mb-4">
                    <h5><b>Thank you very much for shopping at Cian's Poster Store! We hope to see you again soon.</b></h5>
                  </div>
                  
                  <hr/>
                  
                    <div class="d-flex justify-content-between mb-4">
                <h5><b>Your receipt will be emailed to the email address used to create your account.</b></h5>
                  </div>
